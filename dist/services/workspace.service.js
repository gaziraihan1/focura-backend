...
export class WorkspaceService {
    ...
    static async create(userId, data) {
        ...
        if (workspaceCount >= maxAllowed) {
            throw new Error(`Workspace limit reached for your ${userPlan} plan. Allowed: ${maxAllowed}`);
        }
    ...
    // Update workspace
    static async update(workspaceId, userId, data) {
    ...
    // Invite member
    static async inviteMember(workspaceId, inviterId, email, role) {
    ...
    static async removeMember(workspaceId, removerId, memberId) {
        // Check permissions
    ...
    static async updateMemberRole(workspaceId, updaterId, memberId, role) {
    ...
    static async getStats(workspaceId, userId) {
        // Check access
        const member = await prisma.workspaceMember.findFirst({
            where: { workspaceId, userId },
        });
        ...
        const [totalProjects, totalTasks, totalMembers, completedTasks, overdueTasks,] = await Promise.all([
