// src/app.ts
// ─────────────────────────────────────────────────────────────────────────────
// IMPORTANT: This file contains the Express app WITHOUT app.listen() or crons.
// It is imported by:
//   • src/index.ts  (production — adds listen + crons there)
//   • src/tests/**  (tests — supertest wraps the app directly)
//
// WHY: If tests import src/index.ts they trigger:
//   1. app.listen() → port conflict
//   2. initNotificationCrons() → real cron jobs firing during tests
// ─────────────────────────────────────────────────────────────────────────────
